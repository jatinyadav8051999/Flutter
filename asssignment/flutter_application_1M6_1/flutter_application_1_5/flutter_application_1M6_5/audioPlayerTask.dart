...
class AudioPlayerTask extends BackgroundAudioTask {
  ...
  Future<void> onStart(Map<String, dynamic> params) async {
    ...
    await _setAudioSession(); _propogateEventsFromAudioPlayerToAudioServiceClients();
  ...
  void _performSpecialProcessingForStateTransistions() {
    _player.processingStateStream.listen((state) {
      switch (state) { case ProcessingState.completed:
          onPause();
          break;
  ...
  Future<void> onSkipToQueueItem(String mediaId) async {
    ...
    _player.seek(Duration.zero, index: newIndex);// Demonstrate custom events.
